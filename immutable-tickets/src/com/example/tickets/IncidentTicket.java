...
public final class IncidentTicket {
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(this.id, this.reporterEmail, this.title);
        builder.description(this.description);
        builder.priority(this.priority);
        builder.tags(new ArrayList<>(this.tags));
        builder.assigneeEmail(this.assigneeEmail);
        builder.customerVisible(this.customerVisible);
        builder.slaMinutes(this.slaMinutes);
