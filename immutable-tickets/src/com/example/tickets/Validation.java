...
public final class Validation {
    ...
    private static final Pattern TICKET_ID_PATTERN = Pattern.compile("^[A-Z0-9-]+$");
    ...
    public static void requireTicketId(String id) {
        ...
        if (!TICKET_ID_PATTERN.matcher(id).matches()) {
            throw new IllegalArgumentException("id must match " + TICKET_ID_PATTERN.pattern());
        }
    }
